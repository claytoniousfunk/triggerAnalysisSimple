...
void triggerAnalysisSimple_PuJetsEta2p1(std::string triggerFile = "openHLT_CB2_merge.root",
    ...
    treeTrig->SetBranchStatus("HLT_HIPuAK4CaloJet40Eta2p1_v", 1);
    treeTrig->SetBranchStatus("HLT_HIPuAK4CaloJet60Eta2p1_v", 1);
    treeTrig->SetBranchStatus("HLT_HIPuAK4CaloJet80Eta2p1_v", 1);
    treeTrig->SetBranchStatus("HLT_HIPuAK4CaloJet100Eta2p1_v", 1);
    treeTrig->SetBranchStatus("HLT_HIPuAK4CaloJet120Eta2p1_v", 1);
    ...
    treeTrig->SetBranchAddress("HLT_HIPuAK4CaloJet40Eta2p1_v",&triggerDecision_40);
    treeTrig->SetBranchAddress("HLT_HIPuAK4CaloJet60Eta2p1_v",&triggerDecision_60);
    treeTrig->SetBranchAddress("HLT_HIPuAK4CaloJet80Eta2p1_v",&triggerDecision_80);
    treeTrig->SetBranchAddress("HLT_HIPuAK4CaloJet100Eta2p1_v",&triggerDecision_100);
 ...
 //   treeggHiNtuplizer = (TTree*)fileTmp->Get(treePath.c_str());
    ...
    r_40->GetYaxis()->SetRangeUser(0.6,1.4);
