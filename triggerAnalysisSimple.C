...
void triggerAnalysisSimple(std::string triggerFile = "openHLT_merge.root",
                           std::string inputFile = "HiForestMiniAOD_merge.root",
 ...
 //   treeggHiNtuplizer = (TTree*)fileTmp->Get(treePath.c_str());
    ...
    leg->AddEntry(r_60,"HLT_HICsAK4PFJet60Eta1p5_v");
    leg->AddEntry(r_80,"HLT_HICsAK4PFJet80Eta1p5_v");
    leg->AddEntry(r_100,"HLT_HICsAK4PFJet100Eta1p5_v");
    leg->AddEntry(r_120,"HLT_HICsAK4PFJet120Eta1p5_v");
    //leg->SetBorderSize(0);
    r_60->Draw();
    leg->Draw();
    r_80->Draw("same");
