...
void triggerAnalysisSimple_PuJetsEta2p1_noL1Seed(std::string triggerFile = "openHLT_CB2_merge.root",
 ...
 //   treeggHiNtuplizer = (TTree*)fileTmp->Get(treePath.c_str());
    ...
    leg->AddEntry(r_40,"HLT_HIPuAK4CaloJet40Eta2p1_noL1Seed_v","p");
    leg->AddEntry(r_60,"HLT_HIPuAK4CaloJet60Eta2p1_noL1Seed_v","p");
    leg->AddEntry(r_80,"HLT_HIPuAK4CaloJet80Eta2p1_noL1Seed_v","p");
    leg->AddEntry(r_100,"HLT_HIPuAK4CaloJet100Eta2p1_noL1Seed_v","p");
    leg->AddEntry(r_120,"HLT_HIPuAK4CaloJet120Eta2p1_noL1Seed_v","p");
    ...
    la->DrawLatexNDC(0.18,0.73,"|#eta^{jet}| < 2.1, no L1 Seed");
