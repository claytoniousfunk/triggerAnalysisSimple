...
void triggerAnalysisSimple_PuJetsEta5p1(std::string triggerFile = "openHLT_CB2_merge.root",
 ...
 //   treeggHiNtuplizer = (TTree*)fileTmp->Get(treePath.c_str());
    ...
    leg->AddEntry(r_40,"HLT_HIPuAK4CaloJet40Eta5p1_v","p");
    leg->AddEntry(r_60,"HLT_HIPuAK4CaloJet60Eta5p1_v","p");
    leg->AddEntry(r_80,"HLT_HIPuAK4CaloJet80Eta5p1_v","p");
    leg->AddEntry(r_100,"HLT_HIPuAK4CaloJet100Eta5p1_v","p");
    leg->AddEntry(r_120,"HLT_HIPuAK4CaloJet120Eta5p1_v","p");
    ...
    la->DrawLatexNDC(0.18,0.73,"|#eta^{jet}| < 5.1");
